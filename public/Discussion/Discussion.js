      ...
      <div>
        <div>
          <button className="discussion-title">DISCUSSION</button>
            <p className="comments">Kathybeatz: How do you traverse through a tree?</p>
            <p className="comments">MickyDWow: You can traverse through a tree by recursing over each node's children</p>
        </div>
